...
The cognitive baseline covers abstract reasoning, deductive logic, numerical reasoning, verbal reasoning, visual-spatial reasoning, working memory, and processing speed. The pilot bank contains 840 original pilot items: 120 reviewable candidates per domain, with memory and speed represented as distinct task types and deterministic factory variants recorded with provenance.
