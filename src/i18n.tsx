...
const messages = {
  id: {
    ...
    testFacts: '40 soal · 35 menit · diacak',
    ...
    practiceOnly: 'Mode latihan memakai 40 soal yang sama, tetapi tidak menyimpan jawaban dan tidak menghasilkan skor.',
  ...
  en: {
    ...
    testFacts: '40 questions · 35 minutes · randomized',
    ...
    practiceOnly: 'Practice mode uses the same 40 questions, but does not save answers or produce a score.',
