...
const messages = {
  id: {
    ...
    assessmentDescription: 'Asesmen 35 menit dalam enam area berpikir, dilanjutkan dengan laporan visual yang jelas.',
    ...
    sevenScores: 'Enam skor area, akurasi, dan konteks waktu.',
    ...
    testFacts: '48 soal · 35 menit · diacak',
    ...
    practiceOnly: 'Mode latihan memakai 48 soal yang sama, tetapi tidak menyimpan jawaban dan tidak menghasilkan skor.',
  ...
  en: {
    ...
    assessmentDescription: 'A 35-minute assessment across six thinking areas, followed by a clear visual report.',
    ...
    sevenScores: 'Six domain scores, accuracy, and timing context.',
    ...
    testFacts: '48 questions · 35 minutes · randomized',
    ...
    practiceOnly: 'Practice mode uses the same 48 questions, but does not save answers or produce a score.',
